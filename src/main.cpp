...
int64_t nTargetSpacing = 1 * 60;  // Time between reward:    120 Second
...
const string strMessageMagic = "BTC-GREEN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BTC-GREEN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "btc-green.com Block";
        CTransaction txNew;
        txNew.nTime = 1509955500;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1509955500;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1973901;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0da571667594fc72f78feb889844dd50e903ed48518b58b60dac11e30fe3d662"));
        block.print();
