...
cd /home/oanhle/eclipse-workspace/btcgreen
cd src
make -f makefile.unix
chmod -R 777 /home/oanhle/eclipse-workspace/btcgreen/src


touch .BTC-GREEN/btc-green.conf
vim .BTC-GREEN/btc-green.conf
added rpcuser & rpcpassword
start wallet
 ./BTC-GREENd --daemon -txindex
// check processing
 pidof BTC-GREENd
//
